...
public class AdaptadorVisitar extends RecyclerView.Adapter<AdaptadorVisitar.ViewHolder> {


    private Context mcontext;
    private ArrayList<Items> mlist;

    public AdaptadorVisitar(Context context, ArrayList<Items> list) {
        mcontext = context;
        mlist = list;
    }
...
//                Toast.makeText(mcontext,"la posicion es"+position,Toast.LENGTH_SHORT).show();
                    ...
                    switch (position){
                        case 0:
                            Intent intent = new Intent(mcontext, Visitaruno.class);
                            mcontext.startActivity(intent);
                            break;
                        case 1:
                            Intent intent1 = new Intent(mcontext, Visitardos.class);
                            mcontext.startActivity(intent1);
                            break;
                        case 2:
                            Intent intent2 =new Intent(mcontext, Visitartres.class);
                            mcontext.startActivity(intent2);
                            break;
                    case 3:
                        Intent intent3 =new Intent(mcontext, Visitarcuatro.class);
                        mcontext.startActivity(intent3);
                        break;
                    case 4:
                        Intent intent4 =new Intent(mcontext, Visitarcinco.class);
