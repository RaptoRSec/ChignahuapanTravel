...
public class AdaptadorHotel extends RecyclerView.Adapter<AdaptadorHotel.ViewHolder> {
    ...
    public AdaptadorHotel(Context context, ArrayList<Items> list) {
        mcontext = context;
        mlist = list;
    }
...
//                Toast.makeText(mcontext,"la posicion es"+position,Toast.LENGTH_SHORT).show();
                ...
                switch (position){
                    case 0:
                        Intent intent = new Intent(mcontext, hoteluno.class);
                        mcontext.startActivity(intent);
                        break;
                    case 1:
                        Intent intent1 = new Intent(mcontext, hoteldos.class);
                        mcontext.startActivity(intent1);
                        break;
                    case 2:
                        Intent intent2 =new Intent(mcontext, hoteltres.class);
                        mcontext.startActivity(intent2);
                        break;
                    case 3:
                        Intent intent3 =new Intent(mcontext, hotelcuatro.class);
                        mcontext.startActivity(intent3);
                        break;
                    case 4:
                        Intent intent4 =new Intent(mcontext, hotelcinco.class);
                        mcontext.startActivity(intent4);
                        break;
                    case 5:
                        Intent intent5 =new Intent(mcontext,hotelseis.class);
