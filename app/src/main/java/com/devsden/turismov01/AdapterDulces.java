...
public class AdapterDulces extends RecyclerView.Adapter<AdapterDulces.ViewHolder> {
    ...
    public AdapterDulces(Context context, ArrayList<Items> list) {
        mcontext = context;
        mlist = list;
    }
...
//                Toast.makeText(mcontext,"la posicion es"+position,Toast.LENGTH_SHORT).show();
                ...
                switch (position){
                    case 0:
                        Intent intent = new Intent(mcontext, Dulceuno.class);
                        mcontext.startActivity(intent);
                        break;
                    case 1:
                        Intent intent1 = new Intent(mcontext, Dulcedos.class);
